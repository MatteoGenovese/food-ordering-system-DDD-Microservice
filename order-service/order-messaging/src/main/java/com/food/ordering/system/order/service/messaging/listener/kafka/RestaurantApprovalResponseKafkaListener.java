...
import com.food.ordering.system.order.service.domain.ports.input.message.listener.approval.RestaurantApprovalResponseMessageListener;
...
public class RestaurantApprovalResponseKafkaListener
    ...
    public void receive(
        ...
        log.info("{} number of restaurant approval responses received with " +
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
            if (OrderApprovalStatus.APPROVED ==
                ...
                restaurantApprovalResponseMessageListener.orderApproved(
                    ...
                    restaurantApprovalResponseAvroModel.getOrderApprovalStatus()) {
                log.info("Processing rejected order for order id: {}, with " +
                                 "failure messages: {}",
                         restaurantApprovalResponseAvroModel.getOrderId(),
